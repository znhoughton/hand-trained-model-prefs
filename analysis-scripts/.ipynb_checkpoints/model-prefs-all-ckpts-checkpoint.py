...
def run_work_item(item: WorkItem, device: str, out_dir: str) -> None:
    ...
    # ── Early exit check (before loading tokenizer or model) ──
    ...
    # ── Only load tokenizer/model if there's actual work to do ──
    # Use fast tokenizer only for models where slow tokenizer is broken
    try:
